<?php
  ...
  session_start();
  $sesi = isset($_SESSION['admin']) ? $_SESSION['admin'] : "";
  ...
  <header class="main-header clearfix" role="header">
    ...
    <nav id="menu" class="main-nav" role="navigation">
      <ul class="main-menu">
        ...
        <li><a href="#tentang" class="berita">Tentang Kampus</a></li>
        <li class="has-submenu"><a href="#">Departemen</a>
          ...
          <li class="has-submenu"><a href="#"><?= $admin['username']; ?></a>
          <ul class="sub-menu">
            <li><a href="logout.php" onclick="window.location = 'logout.php'">Logout</a></li>
          </ul>
        </li>
      </ul>
    </nav>
          ...
          <div class="modal-body">
            <form action="tambah.php" method="post" enctype="multipart/form-data">
              ...
              <div class="form-group">
                ...
                <textarea type="text" class="form-control" name="isi" placeholder="Isi" style="height: 120px"></textarea>
              </div>
              <div class="form-group">
                <label>Gambar</label>
...
<a href="#" class="btn btn-primary" data-target="#modalTambah" data-toggle="modal" style="float: right; margin-left: -100px; margin-top: 200px;"><i class="fa fa-plus"></i></a>
            <?php
            $img = mysqli_query($db, "SELECT * FROM berita");
          ?>
          ...
          <p style="text-align: justify; text-justify: inter-word; margin-top: 10px; font-size:16px" id="text">
          <?php 
            echo $row['keterangan']; 
          ?>
          </p>
          <a href="delete.php?berita&id=<?php echo $row['id'] ?>" class="btn btn-danger" style="float: right; margin-right: 60px;"><i class="fa fa-minus"></i></a>
          <button class="btn btn-warning" data-target="#modalEdit<?= $row['id'] ?>" data-toggle="modal" style="float: right; margin-right: 10px;"><i class="fa fa-pencil"></i></button>
          <?php 
          }
          $rrt = mysqli_query($db, "SELECT * FROM berita");
          ?>
          </div>
        </div>
        <div class="col-md-12">
  ...
  <?php
      while($row = mysqli_fetch_assoc($rrt)){
    ?>
    <div class="modal" tabindex="-1" role="dialog" id="modalEdit<?= $row['id'] ?>">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
          ...
          <div class="modal-body">
            <form action="edit.php?berita&id=<?php echo $row['id'] ?>" method="post" enctype="multipart/form-data">
              <div class="form-group">
                <label>Judul Berita</label>
              ...
              <div class="form-group">
                <label>Isi Berita</label>
                <textarea type="text" class="form-control" name="isi" style="height: 120px"><?= $row['keterangan']; ?></textarea>
              </div>
              <div class="form-group">
                <label>Gambar</label>
